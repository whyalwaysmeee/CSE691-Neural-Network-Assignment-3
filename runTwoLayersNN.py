...
################################################################################
print ('\nFinding best model for Two layers NN')
learningRates = [0.01,0.03,0.1,0.15,0.2]
# randomly pick up the regularization coefficient
regularizationCoefficients = [0.008,0.01,0.02,0.05,0.1]
for lr in learningRates:
    for rr in regularizationCoefficients:
        model = TwoLayersNN(xTrain.shape[1], 100, numClasses)
        model.train(xTrain,yTrain,lr,rr,100,200,0.95,verbose = False)
